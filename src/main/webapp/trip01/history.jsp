        ...
        <article>
            <div class="pd">
                ...
                <table>
                    <form action="">
                        <tr>
                            <td colspan="3">숙소 예약번호 220307</td>
                        </tr>
                        <tr>
                            <td rowspan="4" class="img"><img class="img2" src="../image/room.jpg"></td>
                            <td>신라스테이 역삼</td>
                            <td rowspan="5" class="rv"><button class="rvbt">리뷰</button></td>
                        </tr>
                        <tr>
                            <td>[내맘대로 8시간 STAY-숙박불가] 체크인 시 배정 (15시 체크인) / DayUse</td>
                        </tr>
                        <tr>
                            <td>2022.04.12 (화) ~ 2022.04.13 (수) | 1박</td>
                        </tr>
                        <tr>
