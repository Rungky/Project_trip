...
<link rel="stylesheet" href="/project_trip/css/main.css">
<title>main</title>
	...
	<div class="main_link">
		<ul>
			<li><a href="${contextPath}/trip?action=reservation.do&dorm_category_no=1">
			...
			<li><a href="${contextPath}/trip?action=reservation.do&dorm_category_no=3"> <span class="link_icon"><img
	...
	<div class="wrap_middle">
		<section>
			<div class="ad">
				...
				<div class="ad_imgs">
					<img src="${contextPath}/image/playStore.png"> <img
						src="${contextPath}/image/appStore.png">
				</div>
			</div>
		</section>
	</div>
